...
## v0.8.4 — Merge
- [x] --merge для --profile: добавление вывода к существующему манифесту
...
## v0.9.3 — Final fixes
- [x] __main__.py: _cmd_validate использовать get_profile() вместо сырых профилей
- [x] cache.py, gitignore.py: комментарии к _MAX_HASH_SIZE и _MAX_GITIGNORE_SIZE
- [x] tests/runner: MagicMock → subprocess.CompletedProcess
- [x] Бамп __version__ до 0.9.3

## v0.9.4 — Final polish
- [x] runner.py: вынести import json на верхний уровень
- [x] gatherer.py: вынести общую логику сборки контента из dry_run и collect
- [x] Бамп __version__ до 0.9.4, синхронизировать pyproject.toml
- [x] CHANGELOG: добавить v0.9.3 и v0.9.4
