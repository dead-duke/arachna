...
- [x] Источник: Архитектура / HIGH + Аудит H-03
- Версия: v0.7.0
...
- [x] Источник: Архитектура / HIGH + Аудит H-04
- Версия: v0.7.0
...
- [x] __main__.py: рефакторинг _cmd_all/_cmd_single
- [x] collector.py: атомарная запись манифеста
