...
- [ ] _write_parts: always use numbered filenames (name_1.md, name_2.md), remove single-part special case
- [ ] _cmd_diff: include snapshot name in output filename (chat-diff-{snapshot}_N.md)
- [ ] _cmd_diff: cross-snapshot naming (chat-diff-{from}-to-{to}_N.md)
- [ ] _write_diff_parts: pass snapshot_id for filename template
- [ ] _cmd_clean: update glob patterns for new filenames
- [ ] Update existing tests expecting chat-code.md to chat-code_1.md
