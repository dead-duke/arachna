...
from arachna.watch.store import gc, stats
...
def test_stats_no_objects_dir(tmp_path):
    from arachna.watch.store import create_snapshot
...
def test_list_snapshots_empty_dir(tmp_path):
    from arachna.watch.store import list_snapshots
...
def test_delete_snapshot_clears_head(tmp_path):
    from arachna.watch.store import _store_root, create_snapshot, delete_snapshot
